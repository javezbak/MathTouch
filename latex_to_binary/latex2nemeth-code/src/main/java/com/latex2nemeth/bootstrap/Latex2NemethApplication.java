...
public class Latex2NemethApplication {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        try {
            ...
            ParsedChapters chapters = Latex.parse(texFile, auxFile, encodingTable, new Preamble());
...
//        }
    ...
    private static void printUsage(Options options) {
        ...
        formatter.printHelp("usage: java -jar latex2nemeth-v1.0.jar [options] texFile auxFile",
